  ...
  return (
    ...
    <div className='flex justify-between items-center'>
     <div>
      ...
      <p className='text-2xl'>$63,204.78</p>
     </div>
    </div>
    <div className='mt-6'>
      <Button 
    ...
    <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
      {earningData.map((item) => (
        <div
        key={item.title}
        className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-[208px] p-4 pt-9 rounded-2xl'
        >
    ...
    <div className='flex gap-10 flex-wrap justify-center'>
       <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
         ...
         <div className='mt-10 flex gap-10 flex-wrap justify-center'>
           ...
           <div>
             <p>
               <span className='text-3xl font-semibold'>$96,558</span>
           ...
           <div className='mt-8'>
             <p>
               <span className='text-3xl font-semibold'>$56,558</span>             </p>
